...
ARGUMENTS
    ...
    '''
    import time
    from pymol import licensing, invocation
    ...
    if 'msg' in info:
        body += info['msg'] + '\n'
    body += 'License Files:\n'
    for licfile in (licensing.get_license_filenames()
            or ['(no license file found)']):
        body += licfile + '\n'
...
def try_cdll_imports():
    # Known required dlls, dump location and try to load
    import ctypes.util

    libs = [
        # PyMOL
        'libpng16', 'libxml2', 'freetype', 'glew32', 'opengl32',
        # indirect
        'glu32',
        # system
        'Ws2_32', 'comctl32', 'comdlg32', 'dhcpcsvc', 'netapi32',
        'User32', 'Advapi32', 'oleaut32', 'ole32', 'shell32', 'shlwapi',
    ]
    ...
    for name in libs:
        ...
        try:
            ...
            print('LoadLibrary({}) failed: {}'.format(name, e))
