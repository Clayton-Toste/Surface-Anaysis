...
def _email_help(cmd):
    ...
    url = "mailto:help@schrodinger.com"
    url += "?subject=" + quote(subject) + "&body=" + quote(body)
    webbrowser.open(url)
    ...
    def get_menudata(self, cmd=None):
        ...
        return [
            ...
            ('menu', 'Edit', [
                ...
                ('separator',),
                ('check', 'Auto-Copy Images', 'auto_copy_images'),
            ]),
            ('menu', 'Build', [
                ('menu', 'Fragment', [
            ...
            ('menu', 'Wizard', [
                ...
                ('menu', 'Demo', [
                    ...
                    ('command', 'Volume Rendering', lambda: cmd.wizard('demo', 'volume')),
            ...
            ('menu', 'Help', [
                ...
                ('separator',),
                ('command', 'Email PyMOL Help', lambda: _email_help(cmd)),
                ('separator',),
