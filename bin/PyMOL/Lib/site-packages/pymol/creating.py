...
NOTES
    ...
    '''
        ...
        try:
            ...
            if not quiet:
                print('Info: Generating map from columns', ampColName, phases, weights)
                print('Info: Resolution limits low=%.2f high=%.2f' % (reso_low, reso_high))
...
SEE ALSO
    ...
    load, copy, extract
        ...
        if not suspend_undo:
            _self.push_undo(extract_sele if extract else "", just_coordinates=0)
            if name in _self.get_names():
